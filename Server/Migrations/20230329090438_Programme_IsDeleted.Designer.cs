...
namespace PannonBlazor.Server.Migrations
{
    ...
    [Migration("20230329090438_Programme_IsDeleted")]
    partial class Programme_IsDeleted
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PannonBlazor.Shared.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PannonBlazor.Shared.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PannonBlazor.Shared.Theme", b =>
                {
                    b.HasOne("PannonBlazor.Shared.Company", "ExternalCompany")
                        .WithMany()
                    ...
                    b.HasOne("PannonBlazor.Shared.Theme", "SourceTheme")
                        .WithMany()
